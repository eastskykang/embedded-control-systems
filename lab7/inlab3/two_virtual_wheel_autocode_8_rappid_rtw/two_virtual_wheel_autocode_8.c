/*
 * File: two_virtual_wheel_autocode_8.c
 *
...
BlockIO_two_virtual_wheel_autoc two_virtual_wheel_autocode_8_B;

/* Block states (auto storage) */
D_Work_two_virtual_wheel_autoco two_virtual_wheel_autocod_DWork;

/* Real-time model */
RT_MODEL_two_virtual_wheel_auto two_virtual_wheel_autocode_8_M_;
RT_MODEL_two_virtual_wheel_auto *const two_virtual_wheel_autocode_8_M =
  &two_virtual_wheel_autocode_8_M_;
 ...
 */
void two_virtual_wheel_autocode_8_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
  /* Task runs when its counter is zero, computed via rtmStepTask macro */
  eventFlags[1] = ((boolean_T)rtmStepTask(two_virtual_wheel_autocode_8_M, 1));
}
...
static void rate_monotonic_scheduler(void)
{
  ...
  two_virtual_wheel_autocode_8_M->Timing.RateInteraction.TID0_1 =
    (two_virtual_wheel_autocode_8_M->Timing.TaskCounters.TID[1] == 0);

  /* Compute which subrates run during the next base time step.  Subrates
   * are an integer multiple of the base rate counter.  Therefore, the subtask
   * counter is reset when it reaches its limit (zero means run).
   */
  (two_virtual_wheel_autocode_8_M->Timing.TaskCounters.TID[1])++;
  if ((two_virtual_wheel_autocode_8_M->Timing.TaskCounters.TID[1]) > 9) {/* Sample time: [0.02s, 0.0s] */
    two_virtual_wheel_autocode_8_M->Timing.TaskCounters.TID[1] = 0;
  }
}

/* Model step function for TID0 */
void two_virtual_wheel_autocode_8_step0(void) /* Sample time: [0.002s, 0.0s] */
{
  ...
  emios_gen_opwfm_fnc(12, two_virtual_wheel_autocode_8_P.Constant1_Value,
                      two_virtual_wheel_autocode_8_P.Constant_Value_j, 128,1);

  /* RateTransition: '<Root>/Rate Transition1' */
  if (two_virtual_wheel_autocode_8_M->Timing.RateInteraction.TID0_1) {
    two_virtual_wheel_autocode_8_B.RateTransition1 =
  ...
  {
    two_virtual_wheel_autocode_8_B.eTPUQuadratureDecoder_o1 = (int32_t)
      ((fs_etpu_qd_get_pc(3)*4)/4);
    if (fs_etpu_qd_get_period(3)==0) {
      two_virtual_wheel_autocode_8_B.eTPUQuadratureDecoder_o2 = 0;
    } else {
      two_virtual_wheel_autocode_8_B.eTPUQuadratureDecoder_o2 = (int32_t) ((60 *
        3.2E+7)/(fs_etpu_qd_get_period(3) * (4000/4)));/* lines on motor = pcincrements_per_rev/4 */
    }

    two_virtual_wheel_autocode_8_B.eTPUQuadratureDecoder_o3 = (int8_t)
      fs_etpu_qd_get_direction(3);
  }

  /* DataTypeConversion: '<S1>/Data Type Conversion' */
  rtb_DataTypeConversion = (uint16_T)
    two_virtual_wheel_autocode_8_B.eTPUQuadratureDecoder_o1;
  ...
  rtb_Sum1 = (real32_T)(int16_T)(uint16_T)(rtb_DataTypeConversion -
    ...
    two_virtual_wheel_autocode_8_P.Gain_Gain_k +
  ...
  two_virtual_wheel_autocod_DWork.FastDynamics_ELAPS_T =
    two_virtual_wheel_autocode_8_M->Timing.clockTick0 -
  ...
  Sum = (rtb_Sum1 -
    ...
    two_virtual_wheel_autocode_8_P.springconstant2_Gain -
    two_virtual_wheel_autocode_8_P.damping4_Gain *
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator2_DSTATE = (real32_T)
    ((real_T)two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator2_gainval *
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator3_DSTATE = (real32_T)
    ((real_T)two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator3_gainval *
     (real_T)two_virtual_wheel_autocod_DWork.FastDynamics_ELAPS_T)
    * (two_virtual_wheel_autocode_8_P.virtualinertia2_Gain * Sum) +
    two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator3_DSTATE;
   ...
   *  Sum: '<Root>/Sum4'
   */
  u = (real_T)(((0.0F - two_virtual_wheel_autocode_8_B.RateTransition1) - Sum) *
               two_virtual_wheel_autocode_8_P.Gain_Gain_n) +
    two_virtual_wheel_autocode_8_P.Constant_Value;

  /* DataTypeConversion: '<Root>/Data Type Conversion3' incorporates:
   *  Gain: '<Root>/Gain'
   *  Saturate: '<Root>/Saturation'
   */
  u = floor((u >= two_virtual_wheel_autocode_8_P.Saturation_UpperSat ?
             two_virtual_wheel_autocode_8_P.Saturation_UpperSat : u <=
             two_virtual_wheel_autocode_8_P.Saturation_LowerSat ?
             two_virtual_wheel_autocode_8_P.Saturation_LowerSat : u) *
            two_virtual_wheel_autocode_8_P.Gain_Gain);
  ...
  two_virtual_wheel_autocode_8_B.DataTypeConversion3 = u < 0.0 ? (uint32_T)
   ...
   */
  u = floor(two_virtual_wheel_autocode_8_P.Constant2_Value);
  if (rtIsNaN(u) || rtIsInf(u)) {
    u = 0.0;
  } else {
    u = fmod(u, 4.294967296E+9);
  ...
  two_virtual_wheel_autocode_8_B.DataTypeConversion2 = u < 0.0 ? (uint32_T)
    -(int32_T)(uint32_T)-u : (uint32_T)u;
  ...
  /*Generate the Output PWM*/
  emios_gen_opwfm_fnc(0, two_virtual_wheel_autocode_8_B.DataTypeConversion3,
                      two_virtual_wheel_autocode_8_B.DataTypeConversion2, 128,1);

  /* RateTransition: '<Root>/Rate Transition' */
  if (two_virtual_wheel_autocode_8_M->Timing.RateInteraction.TID0_1) {
    two_virtual_wheel_autocode_8_B.RateTransition = rtb_Sum1;
  }
  ...
  gpo_writedata_fnc(205, two_virtual_wheel_autocode_8_P.Constant_Value_i);/* GPIO Pin Data Output Registers */
...
void two_virtual_wheel_autocode_8_step1(void) /* Sample time: [0.02s, 0.0s] */
{
  real32_T Sum;
  ...
  two_virtual_wheel_autocod_DWork.SlowDynamics_ELAPS_T =
    two_virtual_wheel_autocode_8_M->Timing.clockTick1 -
   ...
   *  Sum: '<S5>/Sum'
   */
  Sum = (two_virtual_wheel_autocode_8_B.RateTransition -
         two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator1_DSTATE) *
    two_virtual_wheel_autocode_8_P.springconstant1_Gain -
    two_virtual_wheel_autocode_8_P.damping1_Gain *
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator1_DSTATE = (real32_T)
    ((real_T)two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator1_gainval *
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator_DSTATE = (real32_T)
    ((real_T)two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator_gainval *
     (real_T)two_virtual_wheel_autocod_DWork.SlowDynamics_ELAPS_T)
    * (two_virtual_wheel_autocode_8_P.virtualinertia1_Gain * Sum) +
    two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator_DSTATE;
...
void two_virtual_wheel_autocode_8_step(int_T tid)
{
  switch (tid) {
   case 0 :
    two_virtual_wheel_autocode_8_step0();
    break;

   case 1 :
    two_virtual_wheel_autocode_8_step1();
    break;
...
void two_virtual_wheel_autocode_8_initialize(boolean_T firstTime)
{
  (void)firstTime;
  ...
  (void) memset((void *)two_virtual_wheel_autocode_8_M, 0,
                sizeof(RT_MODEL_two_virtual_wheel_auto));

  /* block I/O */
  (void) memset(((void *) &two_virtual_wheel_autocode_8_B), 0,
                sizeof(BlockIO_two_virtual_wheel_autoc));

  {
    two_virtual_wheel_autocode_8_B.RateTransition1 = 0.0F;
    two_virtual_wheel_autocode_8_B.RateTransition = 0.0F;
  }
  ...
  two_virtual_wheel_autocode_8_B.RateTransition1 =
    two_virtual_wheel_autocode_8_P.RateTransition1_X0;
  ...
  two_virtual_wheel_autocod_DWork.UnitDelay_DSTATE =
    two_virtual_wheel_autocode_8_P.UnitDelay_X0;

  /* InitializeConditions for UnitDelay: '<S1>/Unit Delay1' */
  two_virtual_wheel_autocod_DWork.UnitDelay1_DSTATE =
    two_virtual_wheel_autocode_8_P.UnitDelay1_X0;
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator2_DSTATE =
    two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator2_IC;

  /* InitializeConditions for DiscreteIntegrator: '<S2>/Discrete-Time Integrator3' */
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator3_DSTATE =
    two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator3_IC;
  ...
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator1_DSTATE =
    two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator1_IC;

  /* InitializeConditions for DiscreteIntegrator: '<S5>/Discrete-Time Integrator' */
  two_virtual_wheel_autocod_DWork.DiscreteTimeIntegrator_DSTATE =
    two_virtual_wheel_autocode_8_P.DiscreteTimeIntegrator_IC;
}

/* Model terminate function */
void two_virtual_wheel_autocode_8_terminate(void)
{
