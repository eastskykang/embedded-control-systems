...
{
  /* Initialize model */
  two_virtual_wheel_autocode_8_initialize(1);
}
...
void SYSTEM_TASK(void)
{
   ...
   */
  two_virtual_wheel_autocode_8_SetEventsForThisBaseStep(eventFlags);

  /* Set model inputs associated with base rate here */
  two_virtual_wheel_autocode_8_step(0);

  /* Get model outputs here */
  if (eventFlags[1]) {
    /* Set model inputs associated with subrates here */
    two_virtual_wheel_autocode_8_step(1);
