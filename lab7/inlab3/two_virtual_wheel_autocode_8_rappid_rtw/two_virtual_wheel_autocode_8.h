/*
 * File: two_virtual_wheel_autocode_8.h
 *
...
#ifndef RTW_HEADER_two_virtual_wheel_autocode_8_h_
#define RTW_HEADER_two_virtual_wheel_autocode_8_h_
#ifndef two_virtual_wheel_autocode_8_COMMON_INCLUDES_
# define two_virtual_wheel_autocode_8_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "rtGetInf.h"
...
#endif                                 /* two_virtual_wheel_autocode_8_COMMON_INCLUDES_ */

#include "two_virtual_wheel_autocode_8_types.h"
...
extern Parameters_two_virtual_wheel_au two_virtual_wheel_autocode_8_P;

/* Block signals (auto storage) */
extern BlockIO_two_virtual_wheel_autoc two_virtual_wheel_autocode_8_B;

/* Block states (auto storage) */
extern D_Work_two_virtual_wheel_autoco two_virtual_wheel_autocod_DWork;

/* External function called from main */
extern void two_virtual_wheel_autocode_8_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void two_virtual_wheel_autocode_8_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void two_virtual_wheel_autocode_8_initialize(boolean_T firstTime);
extern void two_virtual_wheel_autocode_8_step(int_T tid);
extern void two_virtual_wheel_autocode_8_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_two_virtual_wheel_auto *const
  two_virtual_wheel_autocode_8_M;
 ...
 *
 * '<Root>' : 'two_virtual_wheel_autocode_8'
 * '<S1>'   : 'two_virtual_wheel_autocode_8/ConversionSystem'
 * '<S2>'   : 'two_virtual_wheel_autocode_8/FastDynamics'
 * '<S3>'   : 'two_virtual_wheel_autocode_8/GPIO Blocks'
 * '<S4>'   : 'two_virtual_wheel_autocode_8/RAppID-EC'
 * '<S5>'   : 'two_virtual_wheel_autocode_8/SlowDynamics'
 * '<S6>'   : 'two_virtual_wheel_autocode_8/Subsystem'
 * '<S7>'   : 'two_virtual_wheel_autocode_8/eTPU Blocks'
 */
#endif                                 /* RTW_HEADER_two_virtual_wheel_autocode_8_h_ */
