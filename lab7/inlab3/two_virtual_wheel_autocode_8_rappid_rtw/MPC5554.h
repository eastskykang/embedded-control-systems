/**************************************************************************/
/* FILE NAME: mpc5554.h                      COPYRIGHT (c) FREESCALE 2004 */
...
#pragma ANSI_strict off
  ...
  struct FLASH_tag {
    ...
    union {
      ...
      struct {
       vuint32_t:
        12;                            /* Master ID 15-4 not used on MPC5554 */
        vuint32_t M3PFE:1;
        vuint32_t M2PFE:1;
        vuint32_t M1PFE:1;
        vuint32_t M0PFE:1;
    ...
    union {
      ...
      struct {
       vuint32_t:
        24;                            /* Master ID 15-4 not used on MPC5554 */
        vuint32_t M3AP:2;
        vuint32_t M2AP:2;
        vuint32_t M1AP:2;
        vuint32_t M0AP:2;
  ...
  struct ETPU_tag {
    ...
    struct {
      union {
        ...
        struct {
          vuint32_t CIE:1;             /* Channel Interrupt Enable */
  ...
  struct INTC_tag {
    ...
    } SSCIR[8];                        /* Software Set/Clear Interrupt Register */
