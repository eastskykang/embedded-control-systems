...
MODEL           = two_virtual_wheel_autocode_8
MODULES         = EMIOS_library.c Exceptions.c GPIO_library.c IntcInterrupts.c IntcIsrVectors.c MPC5554_HWInit.c MPC55xx_init_debug.c __ppc_eabi_init.c cpu_init_func.c eTPU_library.c eTPU_util.c emios_init.c etpu_init_fcn.c etpu_qd.c intc_init.c msr_init.c rappid_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c siu_init.c sys_init.c two_virtual_wheel_autocode_8_data.c 
MAKEFILE        = two_virtual_wheel_autocode_8.mk
...
MODELLIB                  = two_virtual_wheel_autocode_8lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-IC:\Users\Embed_Sys_course\git\lab\lab7\inlab3\two_virtual_wheel_autocode_8_rappid_rtw \
	-IC:\Users\Embed_Sys_course\git\lab\lab7\inlab3 \
