...
#define MAKE_HLI_COMPATIBLE(hli_name, c_expr) enum { hli_name=   /*lint -e30*/\
 ((int)(c_expr)) };
  ...
  __asm void __initMMUExternalMemory(void)
  {
    ...
    /* 16 MB memory space, valid, protected, global which matches with all process IDs */
      MAKE_HLI_COMPATIBLE(AXM_0321_EXT_RAM_MAS1_VALUE,MAS1_VALUE(V_VALID,
      IPROT_PROTECTED, TID_GLOBAL, 0, TSIZE_16MB))
      MAKE_HLI_COMPATIBLE(AXM_0321_EXT_RAM_MAS2_FLAGS,MAS2_FLAGS
                          (SHARED_CACHE_STATE_NOT_USED, WRITE_BACK, CACHEABLE,
      MEM_COHERENCE_NREQ, NOT_GUARDED, BIG_ENDIAN ))
      MAKE_HLI_COMPATIBLE(AXM_0321_EXT_RAM_MAS3_FLAGS,MAS3_FLAGS
                          (READ_WRITE_EXECUTE))
#endif
      nofralloc
      mflr r27
